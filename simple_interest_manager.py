...
language_dictionary = {
    ...
    'periods_body':"Insert here the number of periods you intend to mantain your investment",
    'periods_help':"Only positive values allowed",
    'periods_answ':'Number of periods inserted: ',
    'interest_rate_body':"Insert here the interest rate (%) expected from your investment. This rate will be applied to your initial amount for each period of investment",
    ...
    'init_amount_answ':'Você inseriu R$ ',
    'periods_body':"Insira aqui o número de períodos que você pretende manter o valor investido",
    'periods_help':"Apenas valores positivos são permitidos",
    'periods_answ':'Total de períodos inseridos: ',
    'interest_rate_body':"Insira aqui a taxa de juros (%) esperada neste investimento para cada período.",
