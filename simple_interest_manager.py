...
def net_income_calculator(final_amount, init_amount, tax_rate):
    ...
    result = {'net_before_taxes':net_before_taxes, 'net_after_taxes':net_after_taxes, 'total_taxes':total_taxes}
...
if __name__=="__main__":
    ...
    print(f"The final interest rate during the whole period is: {(total_interest-1)*100}%")
    ...
    result = net_income_calculator(final_amount = final_amount, init_amount= init_amount, tax_rate=tax_rate)
